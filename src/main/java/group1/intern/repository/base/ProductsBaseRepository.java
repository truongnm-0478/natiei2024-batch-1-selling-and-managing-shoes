...
public class ProductsBaseRepository implements BaseRepository<Product> {
    ...
    @Override
    public List<Product> fetchAllDataWithoutPagination(List<WhereElements> whereElements, Sort sort, String... relationships) {
    ...
    @Override
    public Page<Product> fetchAllDataWithPagination(List<WhereElements> whereElements, Pageable pageable, String... relationships) {
    ...
    @Override
    public List<Product> fetchAllDataWithFirstQuery(List<WhereElements> whereElements, String baseQuery, Sort sort, Pageable pageable) {
        String whereClause = CommonUtils.getWhereClause(whereElements, "p");
        // sort clause
        String sortClause = (sort == null && pageable != null) ? CommonUtils.getSortClause(pageable.getSort(), "p") : CommonUtils.getSortClause(sort, "p");
